...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SharedPreferences sharedPreferences=this.getSharedPreferences("com.example.imazjav0017.importantplaces", Context.MODE_PRIVATE);
        places.clear();
        locations.clear();
        longitudes.clear();
        latitudes.clear();
        try {
            ...
            longitudes=(ArrayList<String>)ObjectSerializer.deserialize(sharedPreferences.getString
